...
def main(args: argparse.Namespace) -> None:
    ...
    if args.input_file:
        ...
        output_path = Path(args.output_file) if args.output_file else Path("predictions.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-folds", type=int, default=5, help="Number of ensemble folds")
    ...
    parser.add_argument("--label-column", type=str, help="Column name for labels (for evaluation)")
    parser.add_argument("--output-file", type=str, help="Output CSV path for predictions")
